...
//
//
//  Created by Roman Chvalbo on 9/1/17.
//  Copyright © 2017 SapienSolutions, LLC. All rights reserved.
//
/* The SwipeInteractionController class was designed to make segues between ViewControllers smoother and easier to implement. This class will recognize the difference between vertical and horizontal gestures and execute the segue expected by the user. */
