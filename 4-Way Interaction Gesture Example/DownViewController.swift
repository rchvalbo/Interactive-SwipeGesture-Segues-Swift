...
class DownViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        swipeInteractionController.wireToViewController(viewController: self, segueUp: nil, segueDown: "back", segueLeft: nil, segueRight: nil)
...
extension DownViewController: UIViewControllerTransitioningDelegate {
